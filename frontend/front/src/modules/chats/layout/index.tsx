import { Layout, type Breadcrumb, type SidebarButton } from "@/shared/components/layout";
...
const ChatsLayout = ({ children }: Children) => {
    ...
    return <Layout sidebarButtons={asideButtons} breadcrumbs={breadcrumbs}>{children}</Layout>;
};
